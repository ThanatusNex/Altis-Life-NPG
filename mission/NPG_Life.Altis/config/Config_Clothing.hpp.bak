...
class Clothing {
	class bruce {
		...
		uniforms[] = {
			...
			{ "U_C_Poloshirt_blue", "Tickle me Elmo", 250, { "", "", -1 } },
			{ "U_C_Poloshirt_burgundy", "Kermit the Frog", 275, { "", "", -1 } },
			{ "U_C_Poloshirt_redwhite", "Stoned Yoda", 150, { "", "", -1 } },
			{ "U_C_Poloshirt_salmon", "Pinapple", 175, { "", "", -1 } },
			{ "U_C_Poloshirt_stripped", "Stoned Mario", 125, { "", "", -1 } },
			{ "U_C_Poloshirt_tricolour", "Shutup Meg", 350, { "", "", -1 } },
			{ "U_C_Commoner1_1", "Dr Zoidberg", 400, { "", "", -1 } },
			{ "U_C_Poor_2", "Poor Man", 250, { "", "", -1 } },
	...
	class cop {
		...
		uniforms[] = {
			{ "NONE", "Remove Uniform", 0, { "", "", -1 } },
			{ "U_B_CombatUniform_mcam", "Cop Uniform", 25, { "", "", -1 } },
			{ "U_NikosBody", "UnderCover", 75, { "life_coplevel", "SCALAR", 5 } }
		};

		headgear[] = {
			{ "NONE", "Remove Hat", 0, { "", "", -1 } },
			{ "H_Cap_Police", "", 75, { "life_coplevel", "SCALAR", 1 } },
			{ "H_Watchcap_blk", "", 75, { "life_coplevel", "SCALAR", 3 } },
			{ "H_Beret_blk_POLICE", "", 120, { "life_coplevel", "SCALAR", 4 } },
			{ "H_Beret_02", "", 100, { "life_coplevel", "SCALAR", 5 } },
			{ "H_Cap_blk_ION", "Undercover unit ONLY", 100, { "life_coplevel", "SCALAR", 5 } },
			{ "H_Beret_Colonel", "", 100, { "life_coplevel", "SCALAR", 6 } },
			{ "H_CrewHelmetHeli_B", "", 100, { "life_coplevel", "SCALAR", 7 } },
			{ "H_HelmetB_light_black", "", 500, { "life_coplevel", "SCALAR", 13 } }
		};
		...
		goggles[] = {
			...
			{ "G_Lowprofile", "", 150, { "", "", -1 } },
			{ "G_Combat", "", 150, { "", "", -1 } },
			{ "G_Balaclava_blk", "", 500, { "life_coplevel", "", 13 } }
		};
		...
		vests[] = {
			...
			{ "V_PlateCarrierSpec_blk", "", 500, { "life_coplevel", "SCALAR", 1 } },
		...
		backpacks[] = {
			{ "NONE", "Remove Backpack", 0, { "", "", -1 } },
			{ "B_Carryall_khk", "", 3500, { "life_coplevel", "SCALAR", 1 } }
		};
	};
